...
<body>
  ...
  <script>
    ...
    function getSelectedTicket() {
      const selected = document.getElementById("ticket_type").value || "single";
      return ticketOptions[selected] ? selected : "single";
    }
    ...
    function handleBooking(event) {
      ...
      for (let i = 0; i < passengerCount; i++) {
        ...
        const idNum = document.querySelector(`[name="id_${i}"]`).value.trim();
      ...
      document.getElementById("ticket_type").value = "single";
      refreshUI(false);
    }
