...
<body>
  ...
  <script>
    ...
    const ticketOptions = {
      single_short: { label: "Single Ticket - Short Trip: 69 GBP (1 passenger)", count: 1 },
      four_short: { label: "Private Ticket - Short Trip: 266 GBP (4 passengers)", count: 4 },
      single_long: { label: "Single Ticket - Long Trip: 169 GBP (1 passenger)", count: 1 },
      four_long: { label: "Private Ticket - Long Trip: 666 GBP (4 passengers)", count: 4 }
    };
